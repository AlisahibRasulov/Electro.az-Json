        ...
        <div className="col-2xl-6 col-xl-6 col-lg-6 col-md-6" style={{ padding: 0 }}>
          <div className="card-self">
            ...
            <div className="text">
              ...
              <p>
                Electro.az hər müştəriyə xüsusi yanaşma və qabaqcıl texnologiyalı məhsullar təqdim edir. 
                Sürətli çatdırılma və müştəri dəstəyi ilə texnologiyanı hər kəsə yaxınlaşdırırıq.
              </p>
            </div>
          </div>
        </div>
