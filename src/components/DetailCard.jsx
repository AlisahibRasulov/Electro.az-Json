...
import { addToBasket } from '../redux/slices/addToBasketSlice';
import { addToLike, removeLike } from '../redux/slices/addToLikeSlice';
import { CardBasketIcon, CartCheckout, CardLikeIcon, CardLikeFullIcon, StarFull, StarSolid } from '../svg';
import Button from './library/Button';
...
const DetailCard = ({ data }) => {
  ...
  const { discounts, images, title, price, rating, description, categories, brand, dimensions, weight } = data;
        ...
        <div className="detail_bottom">
          <div className="detail_image">
            <div className="main-image">
              <img src={images[selectedImageIndex].imagePath} alt="Product Image" />
            </div>
          ...
          <div className="detail_view">
            <div className="detail-view_top">
              <div className="view-top_text-1">Məhsul mövcuddur</div>
              <div className="view-top_text-2">SKU: TM-DG-SBP-1105-SM-2167</div>
            </div>
            ...
            <div className="detail-view_body">
              ...
              <div className="detail-description">
                <h4 className='font-[600]'>Product Description</h4>
                <p>{description}</p>
              </div>

              <div className="detail-specifications">
                <h4 className='font-[600]'>Specifications</h4>
                <ul>
            ...
            <div className="detail-view_bottom">
              <button className='detail-btn' onClick={handleAddToBasket} style={{ backgroundColor: buttonColor, color: buttonTextColor }}>
                {iconBasket} <div className='detail-btn_text'>{buttonText}</div>
              </button>
            </div>
          </div>
        </div>
