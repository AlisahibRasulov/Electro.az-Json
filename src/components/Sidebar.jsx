...
const Sidebar = () => {
  return (
    <div className="sidebar bg-[#fff] shadow rounded-[12px] w-[100%] h-[100%] min-h-[100%] xl:h-[550px]">
      <ul className="sidebar_menu flex flex-col justify-around w-[100%] h-[100%] 2xl:p-[20px] xl:p-[20px] lg:p-[20px] md:flex-row md:justify-between md:p-[20px] sm:flex-row sm:justify-between sm:p-[20px] 2xs:flex-row 2xs:justify-between 2xs:p-[20px] xs:flex-row xs:justify-between xs:p-[10px]">
        <li className="hover:text-[#D10024] hover-border flex justify-between items-center 2xl:w-[100%] 2xl:h-[20%] 2xl:gap-[10px] xl:w-[100%] xl:h-[20%] xl:gap-[10px] md:flex-col sm:flex-col 2xs:flex-col xs:flex-col">
          <img
          ...
          />
          <NavLink
            className="2xl:text-[18px] xl:text-[18px] lg:text-[18px] md:text-[18px] sm:text-[12px] 2xs:text-[10px] xs:text-[8px]"
            to="/products"
          >
            Hamısı
          </NavLink>
          <img src="../images/icons/icons8-arrow-100.png" alt="" className="w-[20px] md:hidden sm:hidden 2xs:hidden xs:hidden"/>
        </li>
        <li className="hover:text-[#D10024]  hover-border flex justify-between items-center 2xl:w-[100%] 2xl:h-[20%] 2xl:gap-[10px] xl:w-[100%] xl:h-[20%] xl:gap-[10px] md:flex-col sm:flex-col 2xs:flex-col xs:flex-col">
          <img
