...
const SliderCart = () => {
  ...
  return (
    <div className="slider-cart">
      ...
      <div className="slider-cart__slide">
        <div className="slider-cart__image">   
            <img src={products[currentIndex].previewImage} alt={`Slide ${currentIndex}`} />
        </div>
        <div className="slider-cart__info">
          <div>{products[currentIndex].title}</div>
          <del>
            <div>{products[currentIndex].price} ₼</div>
          </del>
          <div>{products[currentIndex].discounts[0].currentPrice} ₼</div>
          <div>{products[currentIndex].brand}</div>
        </div>
      </div>
